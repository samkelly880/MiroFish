    ...
    <div class="main-content">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <!-- Project simulation step intro (new section) -->
...
// Computed: whether submit is allowed
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Immediately navigate to Process page (special id means new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk for main titles, JetBrains Mono for code/labels.
