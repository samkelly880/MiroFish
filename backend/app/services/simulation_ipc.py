...
2. The simulation script polls the command directory, executes commands, and writes responses to responses/
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: Interview both platforms in dual-platform sims; the active platform in single-platform sims
            timeout: Timeout
    ...
    def check_env_alive(self) -> bool:
        ...
        Determined by reading the env_status.json file
        """
