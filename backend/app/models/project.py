...
Persists project state on the server so the frontend does not need to pass large payloads between API calls
"""
...
class Project:
    ...
    # Ontology info (filled after API 1 generates it)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (filled after API 2 completes)
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the path for extracted project text"""
    ...
    def list_projects(cls, limit: Optional[int] = 50) -> List[Project]:
        ...
        Returns:
            Project list, newest first by creation time
        """
        cls._ensure_projects_dir()
